Public Class Form1
    ...
    Private Sub cmdAkarPangkat3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAkarPangkat3.Click
        If txtInput.Text.Length > 0 Then
            Dim number As Double = CDbl(txtInput.Text)
            txtInput.Text = Math.Round(Math.Pow(number, 1.0 / 3.0), 4).ToString()
        End If
    End Sub
